...
public class Learn000Basic {
    ...
    public static void main(String[] args) {
        ...
        long longType = 9000000000000000000L; // 8 bytes | 9 quintillion | 'L' at the end

        float floatType = 3.141592f; // 4 bytes | 6-7 digits | 'f' at the end
        double doubleType = 3.14653589793; // 8 bytes | 15 digits

        char characterType = 'a'; // 2 bytes | single character | single quotes
